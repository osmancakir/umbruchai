# Umbruch AI Guiding Principles

Decisions about Umbruch AI should be guided by the following guiding principles:
...
- **Optimize for Adaptability:** While we feel great about our opinions,
  ...
  So while we try to keep things simple, we want to ensure teams using Umbruch
  AI are able to adapt by switching between third party services to custom-built
