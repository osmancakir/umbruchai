...
As people adapt Umbruch AI to their own needs, they may easily forget to add
...
New users of Umbruch AI won't be blocked by the CSP by default. But this also
means they won't be as safe by default. We'll need to make sure enforcing the
CSP is documented well.
