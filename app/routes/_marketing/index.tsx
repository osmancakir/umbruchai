		...
		<main className="container max-w-5xl pb-24">
			<header className="pt-10 pb-16 sm:pt-16 sm:pb-24">
				<p className="eyebrow flex flex-wrap justify-between gap-x-6 gap-y-1">
					...
					<span>
						Status: <span className="text-signal">in Aufbau</span>
					</span>
				</p>
				...
				<div className="grid gap-12 md:grid-cols-2 md:gap-16">
					<div>
						...
						<p className="text-steel text-brand-md max-w-[52ch]">
							Rechts steht ein Beispiel. Es beschreibt einen Text, den es noch
							nicht gibt — das Magazin ist im Aufbau, und diese Seite zeigt
							vorerst nur, wie es aussehen wird.
						</p>
					</div>
