---
name: umbruch-caching
description:
  Guide on caching with cachified, SQLite cache, and LRU cache for Umbruch AI
categories:
  - caching
  - performance
  - optimization
...
Umbruch AI provides two types of cache:
...
Umbruch AI uses `@epic-web/cachified` as an abstraction for cache management.
...
Umbruch AI includes a dashboard to manage cache:
...
- [Umbruch AI Caching Docs](../../../docs/caching.md)
