---
name: umbruch-testing
description: Guide on testing with Vitest and Playwright for Umbruch AI
categories:
  - testing
  - vitest
  - playwright
...
Umbruch AI uses two types of tests:
...
Umbruch AI provides a `login` fixture for authenticated tests.
...
Umbruch AI uses a separate test database.
...
Umbruch AI uses MSW to mock external services.
...
- ❌ **Not cleaning data after tests**: Umbruch AI cleans automatically, but
...
- [Umbruch AI Testing Docs](../../../docs/testing.md)
