---
name: umbruch-routing
description:
  Guide on routing with React Router and react-router-auto-routes for Umbruch AI
categories:
  - routing
  - react-router
  - file-based-routing
...
Umbruch AI uses `react-router-auto-routes` instead of React Router's standard
...
Umbruch AI encourages placing related code close to where it's used.
...
- ❌ **Creating abstractions prematurely**: Start with simple routes, add
  complexity only when there's a clear benefit
- ❌ **Using React Router's standard convention**: Umbruch AI uses
...
- [Umbruch AI Routing Docs](../../../docs/routing.md)
