---
name: umbruch-react-patterns
description:
  Guide on React patterns, performance optimization, and code quality for Umbruch AI
categories:
  - react
  - performance
  - patterns
...
# Umbruch AI: React Patterns and Guidelines

## When to use this skill

Use this skill when you need to:

- Write efficient React components in Umbruch AI applications
...
Umbruch AI uses React Router loaders for data fetching, not `useEffect`.
...
- [Umbruch AI Docs](../../../docs/README.md)
- [Epic Web Principles](https://www.epicweb.dev/principles)
- `app/routes/` - Example routes using these patterns
- `.cursor/rules/avoid-use-effect.mdc` - Umbruch AI rule for avoiding useEffect
